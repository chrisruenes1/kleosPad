...
/***/ function(module, exports, __webpack_require__) {
	...
	const WebAudioContext = __webpack_require__(12);
...
/***/ function(module, exports, __webpack_require__) {
	...
	Snare.prototype.release = function() {
	  this.oscillatorEnvelope.gain.exponentialRampToValueAtTime(0.01, this.currentTime() + this.hitDuration);
	  
	  this.noiseEnvelope.gain.exponentialRampToValueAtTime(0.01, this.currentTime() + this.duration);
	  
	  this.oscillator.stop(this.currentTime() + this.duration);
	  this.noise.stop(this.currentTime() + this.duration);
	};
